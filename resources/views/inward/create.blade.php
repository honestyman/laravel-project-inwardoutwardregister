        ...
        <section class="content">
            ...
            <div class="box box-solid bg-dark">
                <div class="box-header with-border">
                    <h4 class="box-title"><i class="mdi mdi-file-chart fa-lg"></i> INWARD ADD PAGE</h4>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form" method="POST" action="{{ route('inwardSave') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control{{ $errors->has('inward_no') ? ' is-invalid' : '' }}" value="{{ old('inward_no') }}" id="inward-no" placeholder="Enter Inward No." name="inward_no">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control datepicker pull-right{{ $errors->has('inward_date') ? ' is-invalid' : '' }}" value="{{ old('inward_date') }}" id="inward-date" placeholder="Select Inward Date" name="inward_date" autocomplete="off">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control datepicker pull-right{{ $errors->has('receive_date') ? ' is-invalid' : '' }}" value="{{ old('receive_date') }}" id="receive-date" placeholder="Select Receive Date" name="receive_date" autocomplete="off">
                            ...
                            <div class="form-group col-md-3" id="outward-id">
                                ...
                                <select class="form-control select2{{ $errors->has('outward_id') ? ' is-invalid' : '' }}" name="outward_id" style="width: 100%;">
                                    ...
                                    @foreach ($outwards as $id => $name)
                                        <option value="{{ $id }}" {{ old('outward_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="from_details_address" value="{{ old('from_details_address') }}" id="from-details-address" placeholder="Enter From Address">
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="courier-details-courier-name" value="{{ old('courier_details_courier_name') }}" name="courier_details_courier_name" placeholder="Enter Courier Name">
                            </div>
                        </div>
