        ...
        <section class="content">
            ...
            <div class="box box-solid bg-dark">
                <div class="box-header with-border">
                    <h4 class="box-title"><i class="mdi mdi-file-chart fa-lg"></i> DEPARTMENT EDIT PAGE</h4>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('departmentUpdate', $department->id) }}">
                    @csrf
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $department->name }}" id="department_name" name="name" placeholder="Enter Department Name">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="remarks" name="remarks" placeholder="Enter Remarks">{{ $department->remarks }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
