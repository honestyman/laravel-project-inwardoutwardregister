        ...
        <section class="content">
            ...
            <div class="box box-solid bg-dark">
                <div class="box-header with-border">
                    <h4 class="box-title"><i class="mdi mdi-file-chart fa-lg"></i> OUTWARD ADD PAGE</h4>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form" method="POST" action="{{ route('outwardSave') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control{{ $errors->has('outward_no') ? ' is-invalid' : '' }}" value="{{ old('outward_no') }}" id="outward-no" placeholder="Enter Outward No." name="outward_no">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control datepicker pull-right{{ $errors->has('outward_date') ? ' is-invalid' : '' }}" value="{{ old('outward_date') }}" id="outward-date" placeholder="Select Outward Date" name="outward_date" autocomplete="off">
                            ...
                            <div class="form-group col-md-6" id="mode-id">
                                ...
                                <select class="form-control select2{{ $errors->has('mode_id') ? ' is-invalid' : '' }}" name="mode_id" style="width: 100%;">
                                    ...
                                    @foreach ($modes as $id => $name)
                                        <option value="{{ $id }}" {{ old('mode_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control datepicker pull-right{{ $errors->has('letter_date') ? ' is-invalid' : '' }}" value="{{ old('letter_date') }}" id="letter-date" name="letter_date" placeholder="Select Letter Date" autocomplete="off">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control{{ $errors->has('letter_ref_no') ? ' is-invalid' : '' }}" value="{{ old('letter_ref_no') }}" name="letter_ref_no" id="letter-ref-no" placeholder="Enter Letter No.">
                            ...
                            <div class="form-group col-md-3" id="inward-id">
                                ...
                                <select class="form-control select2{{ $errors->has('inward_id') ? ' is-invalid' : '' }}" name="inward_id" style="width: 100%;">
                                    ...
                                    @foreach ($inwards as $id => $name)
                                        <option value="{{ $id }}" {{ old('inward_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="from_details_person_name" value="{{ old('from_details_person_name') }}" id="from-details-person-name" placeholder="Enter From Person Name">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('to_details_name') ? ' is-invalid' : '' }}" value="{{ old('to_details_name') }}" name="to_details_name" id="to-details-name" placeholder="Enter Name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="to_details_place" value="{{ old('to_details_place') }}" id="to-details-place" placeholder="Enter Place">
                                </div>
                                <div class="form-group">
                                    <label for="to-details-address">Address</label>
                                    <input type="text" class="form-control" name="to_details_address" value="{{ old('to_details_address') }}" id="to-details-address" placeholder="Enter To Address">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control select2" name="courier_id" style="width: 100%;">
                                    ...
                                    @foreach ($couriers as $id => $name)
                                        <option value="{{ $id }}" {{ old('courier_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="courier-details-receipt-no">Receipt No</label>
                                <input type="text" class="form-control" id="courier-details-receipt-no" value="{{ old('courier_details_receipt_no') }}" name="courier_details_receipt_no" placeholder="Enter Receipt No">
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control datepicker pull-right{{ $errors->has('courier_details_receipt_date') ? ' is-invalid' : '' }}" value="{{ old('courier_details_receipt_date') }}" id="courier-details_receipt_date" name="courier_details_receipt_date" placeholder="Select Receipt Date" autocomplete="off">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control{{ $errors->has('courier_details_amount') ? ' is-invalid' : '' }}" id="courier-details-amount" value="{{ old('courier_details_amount') }}" name="courier_details_amount" placeholder="Enter Amount">
                                @if ($errors->has('courier_details_receipt_date'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('courier_details_receipt_date') }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                <div class="controls">
                                    <input type="checkbox" id="courier-details-is-return" name="courier_details_is_return" value=1 {{ old('courier_details_is_return') == 1 ? true : false }}>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control datepicker pull-right{{ $errors->has('courier_details_return_date') ? ' is-invalid' : '' }}" value="{{ old('courier_details_return_date') }}" id="courier-details-return-date" name="courier_details_return_date" placeholder="Select Return Date" autocomplete="off">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" id="courier-details-return-reason" name="courier_details_return_reason" placeholder="Enter Description">{{ old('courier_details_return_reason') }}</textarea>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="courier-details-description" name="courier_details_description" placeholder="Enter Description">{{ old('courier_details_description') }}</textarea>
                            </div>
                        </div>
